...
tau_c =  5.83; %3.28; % core transit time (s)
tau_l =  9.25; %8.26; %5.85; % external loop transit time (s)
...
W_f  = 1373.375; %calcd from m_f/tau_c 1.414E3; % fuel flow rate (kg/s)
m_f  = 8006.77; %477.6; % fuel mass in core (kg) corrected error from 67-102 (might have affected responsiveness)
...
lam_I    = 2.875e-5;  % decay constant for I-135 
lam_Xe   = 2.0916e-5; % decay constant for Xe-135
