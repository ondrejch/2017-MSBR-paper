...
% reactdata = [0 0];
% reacttime = [0 500];
reactdata = [0 6E-4 0 -6E-4 0 6E-4 0 -6E-4 0 6E-4 0 -6E-4 0];
reacttime = [0 500 550 650 700 800 850 950 1000 1100 1150 1250 1300];
...
W_f  = 1.414E4; % fuel flow rate (kg/s)
m_f  = 4776; % fuel mass in core (kg)
